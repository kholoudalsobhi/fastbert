...
from fast_bert.data_qa import BertQADataBunch
from fast_bert.learner_util import Learner
from fast_bert import utils_squad_evaluate
...
from fast_bert.utils_squad_evaluate import EVAL_OPTS, main as evaluate_on_squad
    ...
    for (example_index, example) in enumerate(all_examples):
        ...
        for pred in prelim_predictions:
            ...
            if pred.start_index > 0:  # this is a non-null prediction
                ...
                final_text = get_final_text(tok_text, orig_text, logger, verbose_logging)
...
def get_final_text(pred_text, orig_text, logger, verbose_logging=False):
